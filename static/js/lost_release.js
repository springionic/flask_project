 ...
 function xmTanUploadImg(obj) {
  ...
  {	
	...
	if(title.match(/^\s*$/))
	  ...
	  function lost_time_check()
  {	
  	var lost_time = document.getElementById("lost_time_input").value;
	if(lost_time.match(/^\s*$/))
		{document.getElementById("lost_time_tip").style.visibility="visible";}
	else{document.getElementById("lost_time_tip").style.visibility="hidden";}
	  
	}
	  function lost_place_check()
  {	
  	var lost_place = document.getElementById("lost_place_input").value;
	if(lost_place.match(/^\s*$/))
		{document.getElementById("lost_place_tip").style.visibility="visible";}
	else{document.getElementById("lost_place_tip").style.visibility="hidden";}
